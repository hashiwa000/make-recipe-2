...
- [ ] T070 [P] 契約スキーマ検証: backend/tests/contract/openapi-validator.spec.ts（contracts/openapi.yaml と各応答の整合を検証）
...
- 総タスク数: 70
- ストーリー別内訳: US1=17（T021–T032, T056–T058, T065–T066）, US2=9（T033–T041）, US3=8（T042–T049）, その他=12（T001–T020の基盤含む CLI/共有/テストランナー/スキーマ検証）
